...
# This script scaffolds the new layered architecture for the Crypto Scanner project.

PROJECT_NAME="cryptoscanner"
...
touch cmd/scanner/main.go
touch internal/app/app.go
touch internal/domain/ticker.go
touch internal/exchange/exchange.go
touch internal/exchange/binance.go
